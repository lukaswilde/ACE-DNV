...
import numpy as np
from config import EXP, OUT_DIR, VALID_METHOD
...
from modules.preprocess import (
    data_balancer_nonRandom,
    data_balancer_Random,
    divider_randomInnerEventSplit,
)
...
if VALID_METHOD == "LOO":  # for leave-one-out validation
    ...
    print(
        "AD-HOC: Shuffle and learning. CAUTION: event-level scores will be meaningless in this experiment",
    )
